...
data_root = '/home/Desktop/mnt/data/our_dataset/' #'/home/Downloads/coco2014/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/train_txt.json', #'annotations/instances_train2014.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/train_txt.json', #+ 'annotations/instances_val2014.json',
