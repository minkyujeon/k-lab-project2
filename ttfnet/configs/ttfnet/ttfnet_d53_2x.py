...
data_root = '/home/Desktop/mnt/data/k-lab/our_dataset/' #'/home/Downloads/coco2014/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances.json', #'annotations/instances_train2014.json',
        img_prefix=data_root + 'JPEGImages/', #+ 'images/train2014/',
        img_scale=(512, 512),
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances.json', #+ 'annotations/instances_val2014.json',
        img_prefix=data_root + 'JPEGImages/', # + 'images/val2014/',
        img_scale=(512, 512),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0,
...
load_from = 'pretrain/epoch_24.pth'#'pretrain/ttfnet53_2x-b381dd.pth'
resume_from = None
workflow = [('train', 1)]
