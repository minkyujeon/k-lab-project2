# python demo.py --checkpoint-path ./checkpoint_iter_370000.pth --video ./test_video/video.mp4
import argparse
...
from pytorch_openpose.modules.load_state import load_state
from pytorch_openpose.modules.pose import Pose, propagate_ids
from pytorch_openpose.val import normalize, pad_width
